...
import activeset.kwplus.ActiveSetKWPlus;
import util.Parameter;

public class ActiveSetKWPlusMain {
	...
	public static void main(String[] args) {
		...
		Parameter.LOG_BASE = 1.0 + Parameter.EPSILON;

		ActiveSetKWPlus windowOpt = new ActiveSetKWPlus();
		windowOpt.streaming();
	}
